...
//INTRO IMAGE
import artImage from '../../public/assets/images/webdeveloper.png';


export default function Intro(){
    return(
        <section className="intro--section _landing ">
        <div className="container">
            <div className="row align-items-center">
              <div className="col-md-6  intro--section--col mb-2">
                  <h2 className="display-5">
                    We Are Everything We Aspire To Be
                  </h2>
                  <p className="display-para">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, voluptatum? Repellendus repudiandae similique fuga distinctio atque vitae, quia, error id aliquam ad voluptas animi eius facilis
                  </p>
                  <Button pad={'0.7rem'} type={'default'} text={'Get Started'} />
              </div>
              <div className="col-md-6  intro--section--col2">
                  <Image src={artImage} placeholder="blur"  />
              </div> 
            </div> 
        </div>
        <div className="container section-b-bottom">
          <div className="row">
              <IntroCard icon={
